...
class EstateRegisteredOnlineYesNoControllerSpec extends SpecBase {
  ...
  "EstateRegisteredOnline Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[EstateRegisteredOnlineYesNoView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(EstateRegisteredOnlineYesNoPage, true).success.value
